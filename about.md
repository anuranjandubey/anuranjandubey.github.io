...
<div class="row" style="display: block; ">
	...
	<div style="display: grid; grid-gap: 5px; grid-template-columns: repeat(auto-fit, 100px ;grid-template-rows: repeat(2, 100px);">
		<iframe width="100%" height="300" style="overflow-x:auto;" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSpc8nxH812_2kqYH0c-FArPsoVHk05ZMc_p6otmm8tDuURpI2pzg11hqcrcDW_6EiNwvlzpB3z6Lrl/pubchart?oid=1345969048&amp;format=interactive"></iframe>
	</div>
</div>
