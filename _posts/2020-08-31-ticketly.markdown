...
![Ticketly](assets/images/fast/Ticketly.png)
## Object Model
...
![UML](assets/images/fast/UML_Diagram.png)
...
![Design](assets/images/fast/MovieAppArchitecture.png)
...
![ScanLatency](assets/images/fast/cloudwatch_scan_latency.png)
...
![ScalingPolicies](assets/images/fast/scaling_policies_network.png)

### Node Status on AWS Dashboard
![NodeStatus](assets/images/fast/node_status.png)
...
![NodeAlarm](assets/images/fast/sns_topic_alarm.png)
...
![pytest](assets/images/fast/test.png)
